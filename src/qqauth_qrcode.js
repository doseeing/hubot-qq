...
(function() {
  ...
  function print_terminal_qrcode(file_path, callback) {
    ...
    image.onload = function(){
      ...
      try{
        ...
        var qrcodeTerm = require('qrcode-terminal');
        qrcodeTerm.generate(result);
        callback(null);
      }catch(e){
        callback('unable to read qr code')
      }
    }
    image.src = filename
  }
